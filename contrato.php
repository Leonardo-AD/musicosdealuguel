...
<div class="container" id="corpo">
 <h2 class="pagm">Contratação do Músico</h2>
 <form class="form-horizontal" action="todos.php" method="POST">
<div class="form-group">
   ...
   <div class="form-group" id="set">
        <label class="control-label col-sm-2" for="address">Local:</label>
        <div class="col-sm-10">          
	...
	<div class="form-group" id="qui">
        <label class="control-label col-sm-2" for="cel">Horário:</label>
        <div class="col-sm-10">          
          <input type="text" class="form-control" id="cel" placeholder="Hora (apenas números)" name="cel" onkeyup="validar(this,'num');" maxlength="13" required>
        </div>
      </div> 
      <div class="form-group">
		...
		<div class="form-group" id="set">
        <label class="control-label col-sm-2" for="born" id="sex"></label>
        <div class="col-sm-10" id ="born">                        
          <select class="selectpicker" name="gen">
